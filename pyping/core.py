...
This is a fork of https://github.com/Akhavi/pyping
which is a fork of https://github.com/socketubs/Pyping
...
class Ping(object):
    def __init__(self, destination, timeout=1000, packet_size=55, own_id=None, quiet_output=True, udp=False, sourceaddress=False):
        ...
        self.unknown_host = self.response.unknown_host
        self.seq_number = 0
        self.send_count = 0
    ...
    def print_exit(self):
        ...
        if lost_count == 0 and self.send_count == 0:
            lost_rate = 100
            msg = "Request timed out."
            self.response.ret_code = 1
        else:
